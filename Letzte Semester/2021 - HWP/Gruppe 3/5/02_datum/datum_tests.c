...
START_TEST(datum_ist_davor_gleicher_monat_gleicher_tag)
{
#line 94
    struct datum a, b;
...
START_TEST(datum_ist_danach_gleicher_monat_gleiches_jahr)
{
#line 108
    struct datum a, b;
...
int main(void)
{
    ...
    tcase_add_test(tc1_1, datum_ist_davor_gleicher_monat_gleicher_tag);
    tcase_add_test(tc1_1, datum_ist_davor_gleicher_monat_gleiches_jahr);
    tcase_add_test(tc1_1, datum_ist_danach_gleicher_monat_gleiches_jahr);
